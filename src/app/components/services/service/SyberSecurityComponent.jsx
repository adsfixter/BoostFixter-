...
export default function SyberSecuritySection() {
  const services = [
    {
      number: "01",
  ...
  return (
    <div className="bg-white">
        ...
        <div className="mx-auto max-w-7xl">
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {services.map((service) => (
              <div
                key={service.number}
                className="flex flex-col justify-between p-6 transition-all duration-300 bg-[#F8F8F8] shadow-sm rounded-xl hover:shadow-md"
              >
                <div>
      ...
      <section className="pb-10 overflow-hidden bg-white">
