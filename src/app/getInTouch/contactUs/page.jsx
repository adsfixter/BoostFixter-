    ...
    <div>
      ...
      >
        ...
        <div className="relative z-10 px-6 text-center text-white">
          ...
          <div className="flex items-center justify-center space-x-2 text-lg">
            ...
            <span>||</span>
            <span className="text-[#0AB99D] font-semibold">Contact</span>
          </div>
        </div>
      </section>
      ...
      <section>
        <div className="px-6 py-16 bg-gray-50">
          <div className="grid max-w-6xl gap-12 p-10 mx-auto bg-white shadow-lg md:grid-cols-2 rounded-2xl">
            ...
            <div>
              ...
              <div className="mt-8 space-y-6">
                {/* Address */}
                <div className="flex items-start p-5 space-x-4 border border-gray-100 shadow-sm bg-gray-50 rounded-xl">
        ...
        <div className="bg-[#0AB99D] grid grid-cols-1 md:grid-cols-2 justify-center items-center py-12 text-center text-white">
          ...
          <div className="flex justify-center">
            <input
              ...
              className="px-4 py-4 text-gray-900 bg-white rounded-l-lg w-72 focus:outline-none"
            />
            <button className="px-6 py-2 text-white transition bg-black rounded-r-lg hover:bg-gray-800">
              Subscribe Now
            </button>
          </div>
        </div>
